      ...
      <div ref={avatarRef} className="bg-sun-card rounded-[16px] border border-sun-border p-5 space-y-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="font-semibold text-sun-ink">{name}</p>
            {memberSince && (
        ...
        {editing ? (
          ...
          <div className="space-y-3">
            <div>
              <label className="block text-xs font-medium text-sun-mute mb-0.5">Name</label>
              <p className="text-sm text-sun-ink">{name}</p>
            </div>
            <div>
              <label className="block text-xs font-medium text-sun-mute mb-0.5">Phone</label>
              <p className="text-sm text-sun-ink">{phone || <span className="text-sun-mute">Not set</span>}</p>
            </div>
          </div>
        )}
      </div>
